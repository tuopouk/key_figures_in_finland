...
definitions = pd.read_csv("./assets/definitions_sv.csv").set_index("key_figure")
...
layout = dbc.Container(
    [
        html.H1(
            "Finlands regionala nyckeltal", className="fw-bold display-1 text-center"
        ),
        dbc.Row(
            [
                dbc.Col(
                            ...
                            [
                                dbc.CardBody(
                                    [
                                            ...
                                            [
                                                dbc.Col(
                                                    [
                                                        html.H2("Nyckeltal"),
                                                        dcc.Dropdown(
                                                            id="key-figures-finland-key-figure-selection-sv",
                                                ...
                                                dbc.Col(
                                                    [
                                                        html.H2("Region nivå"),
                                                        dcc.Dropdown(
                                                            id="key-figures-finland-region-selection-sv",
                                                            options=[
                                                                "Landskap",
                                                                "Ekonomisk region",
                                                                "Kommun",
                                        ...
                                        html.Div(
                                            id="key-figures-finland-whole-country-header-sv",
                                            className="text-center card-title mt-5 mb-3",
                                        ),
                                        dcc.Graph(
                                            id="key-figures-finland-timeseries-sv",
                                            className="border",
                                            figure=default_fig,
                                            config=config,
                                        ),
                                        dcc.Loading(
                                            [
                                                dcc.Store(
                                                    id="key-figures-finland-series-data-region-sv"
                                                ),
                                                dcc.Store(
                                                    id="key-figures-finland-series-data-subregion-sv"
                                                ),
                                                dcc.Store(
                                                    id="key-figures-finland-series-data-municipality-sv"
                                                ),
                                            ]
                                        ),
                                        dbc.Row(
                                            [
                                                dbc.Col(
                                                    [
                                                        html.H3(
                                                            "Diagram", className="mt-2"
                                                        ),
                                                        dcc.Dropdown(
                                                            id="key-figures-finland-chart-selection-sv",
                                                            options=[
                                                                "ytdiagram",
                                                                "linjediagram",
                                                            ],
                                                ...
                                                dbc.Col(
                                                    [
                                                        ...
                                                        dcc.Dropdown(
                                                            id="key-figures-finland-chart-template-sv",
                                                            options=sorted(
                                                                [
                                                                    "bootstrap tema",
                                                                    "plotly",
                                ...
                                dbc.CardFooter(
                                    [
                                        ...
                                        html.A(
                                            "Statistikcentralen",
                                            href="https://pxdata.stat.fi/PxWeb/pxweb/sv/Kuntien_avainluvut/Kuntien_avainluvut__2021/",
                                            target="_blank",
                                        ),
                                    ],
                                    ...
                                    [
                                        ...
                                        dbc.Row(
                                            [
                                                dbc.Col(
                                                    [
                                                        html.H3(
                                                            "Karttyp", className="mt-2"
                                                        ),
                                                        dcc.Dropdown(
                                                            id="key-figures-finland-map-type-sv",
                                                            options=sorted(
                                                                [
                                                                    "open-street-map",
                                                                    "carto-positron",
                                                ...
                                                dbc.Col(
                                                    [
                                                        ...
                                                        dcc.Dropdown(
                                                            id="key-figures-finland-map-colorscale-sv",
                                                            options=sorted(
                                                                [
                                                                    "Blackbody",
                                                                    "Bluered",
                                        ...
                                        dbc.Row(
                                            [
                                                ...
                                                html.Div(
                                                    id="key-figures-finland-audio-sv"
                                                ),
                                            ]
                                        ),
                                    ]
...
@callback(
    Output("key-figures-finland-audio-sv", "children"),
    Input("key-figures-finland-key-figure-selection-sv", "value"),
)
def update_playback(key_word):
    kw = re.sub(r"\W+", "", key_word.split(",")[0])
    return html.Audio(
        src=f"./assets/recordings/sv/{kw}.mp3", controls=True, autoPlay=False
    )


@callback(
    Output("key-figures-finland-definition-sv", "children"),
    Input("key-figures-finland-key-figure-selection-sv", "value"),
)
...
def update_timeseries_chart(
    ...
    loc_string = {
        True: (f": {location[0]}").replace(": HELA LANDET", " Finland"),
        False: f" utvalda {region}er".lower(),
    }[len(location) == 1]
    template = template_from_url(theme) if template == "bootstrap tema" else template

    name = dff["dimensions"].values[0]
    dff = dff.reset_index().rename(
        columns={"value": name, "Region": region, "Year": "År"}
    )
    ...
    if chart_type == "linjediagram":
        fig = px.line(
            ...
            color=region,
            template=template,
            hover_data=[region, "År", name],
            title=f"{kf} per år i<b>{loc_string}<b>",
        )
...
@callback(
    Output("key-figures-finland-header-sv", "children"),
    Input("key-figures-finland-key-figure-selection-sv", "value"),
...
@callback(
    Output("key-figures-finland-whole-country-header-sv", "children"),
    Input("key-figures-finland-key-figure-selection-sv", "value"),
)

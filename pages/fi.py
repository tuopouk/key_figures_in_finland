...
layout = dbc.Container(
    [
        html.H1(
            "Suomen avainluvut alueittain", className="fw-bold display-1 text-center"
        ),
        dbc.Row(
            [
                dbc.Col(
                            ...
                            [
                                dbc.CardBody(
                                    [
                                            ...
                                            [
                                                dbc.Col(
                                                    [
                                                        html.H2("Avainluku"),
                                                        dcc.Dropdown(
                                                            id="key-figures-finland-key-figure-selection-fi",
                                                ...
                                                dbc.Col(
                                                    [
                                                        html.H2("Aluetaso"),
                                                        dcc.Dropdown(
                                                            id="key-figures-finland-region-selection-fi",
                                                            options=[
                                                                "Maakunta",
                                                                "Seutukunta",
                                                                "Kunta",
                                        ...
                                        dcc.Loading(
                                            [
                                                dcc.Store(
                                                    id="key-figures-finland-series-data-region-fi"
                                                ),
                                                dcc.Store(
                                                    id="key-figures-finland-series-data-subregion-fi"
                                                ),
                                                dcc.Store(
                                                    id="key-figures-finland-series-data-municipality-fi"
                                                ),
                                            ]
                                        ),
                                        dbc.Row(
                                            [
                                                dbc.Col(
                                                    [
                                                        html.H3(
                                                            "Kuvaaja", className="mt-2"
                                                        ),
                                                        dcc.Dropdown(
                                                            id="key-figures-finland-chart-selection-fi",
                                                            options=[
                                                                "pinta-ala",
                                                                "viiva",
                                                            ],
                                                ...
                                                dbc.Col(
                                                    [
                                                        ...
                                                        dcc.Dropdown(
                                                            id="key-figures-finland-chart-template-fi",
                                                            options=sorted(
                                                                [
                                                                    "bootstrap-teema",
                                                                    "plotly",
                                ...
                                dbc.CardFooter(
                                    [
                                        ...
                                        html.A(
                                            "Tilastokeskus",
                                            href="https://pxdata.stat.fi/PxWeb/pxweb/fi/Kuntien_avainluvut/Kuntien_avainluvut__2021/",
                                            target="_blank",
                                        ),
                                    ],
                                    ...
                                    [
                                            ...
                                            [
                                                dbc.Col(
                                                    [
                                                        ...
                                                        dcc.Dropdown(
                                                            id="key-figures-finland-map-type-fi",
                                                            options=sorted(
                                                                [
                                                                    "open-street-map",
                                                                    "carto-positron",
                                                ...
                                                dbc.Col(
                                                    [
                                                        ...
                                                        dcc.Dropdown(
                                                            id="key-figures-finland-map-colorscale-fi",
                                                            options=sorted(
                                                                [
                                                                    "Blackbody",
                                                                    "Bluered",
                                        ...
                                        dbc.Row(
                                            [
                                                ...
                                                html.Div(
                                                    id="key-figures-finland-audio-fi"
                                                ),
                                            ]
                                        ),
                                    ]
...
def update_timeseries_chart(
    ...
    loc_string = {
        True: (f": {location[0]}").replace(": KOKO MAA", " Suomessa"),
        False: f" valituissa {region}".replace("unta", "unnissa").lower(),
    }[len(location) == 1]
    ...
    dff = dff.reset_index().rename(
        columns={"value": name, "Region": region, "Year": "Vuosi"}
    )
    ...
    if chart_type == "viiva":
        fig = px.line(
            ...
            color=region,
            template=template,
            hover_data=[region, "Vuosi", name],
            title=f"{kf} vuosittain<b>{loc_string}<b>",
        )

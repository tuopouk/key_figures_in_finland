...
whole_country_df = pd.DataFrame(data_df.set_index('name').loc['WHOLE COUNTRY'].sort_index())
                        ...
                        dbc.CardBody([
                            ...
                            dbc.Row([
                                ...
                                dbc.Col([
                                    ...
                                    dcc.Dropdown(id = 'key-figures-finland-region-selection-en',
                                                 options = ['Region','Sub-region','Municipality'],
                                                 value = 'Region',
                                                 className = 'text-dark bg-light text-nowrap'
                                                 )
                                    ])
                                ]),
                            html.Div(id = 'key-figures-finland-whole-country-header-en', className="text-center card-title mt-5 mb-3"),
                            
                            dcc.Graph(id = 'key-figures-finland-timeseries-en', className="border",figure = default_fig, config = config),
                            dcc.Loading([
                                dcc.Store(id = 'key-figures-finland-series-data-region-en'),
                                dcc.Store(id = 'key-figures-finland-series-data-subregion-en'),
                                dcc.Store(id = 'key-figures-finland-series-data-municipality-en')
                            ]),
                            dbc.Row([
                            
                                dbc.Col([
                                    html.H3('Change chart type', className = 'mt-2'),
                                    dcc.Dropdown(id = 'key-figures-finland-chart-selection-en',
                                                 options = ['area', 'line'],
                                                 value = 'line',
                                                 className = 'text-dark bg-light text-nowrap'
                                                 )
                                ...
                                dbc.Col([
                                    ...
                                    dcc.Dropdown(id = 'key-figures-finland-chart-template-en',
                                                 options = sorted([
                                                     "bootstrap_theme",
                                                     "plotly",
                                                     "ggplot2",
                        ...
                        dbc.CardBody([
                            ...
                            dbc.Row([
                                ...
                                dbc.Col([
                                    ...
                                    dcc.Dropdown(id = 'key-figures-finland-map-type-en', 
                                ...
                                dbc.Col([
                                    ...
                                    dcc.Dropdown(id = 'key-figures-finland-map-colorscale-en', 
...
def update_timeseries_chart(key_figure, 
    ...
    loc_string = {True:(f': {location[0]}').replace(': WHOLE COUNTRY',' in Finland'), False: f'selected {region}s'.replace('ty','ties').replace('Muni','muni').replace('Region','region').replace('Sub-r','sub-r')}[len(location)==1]
...
@callback(Output('key-figures-finland-header-en','children'),Input('key-figures-finland-key-figure-selection-en', 'value'),Input('key-figures-finland-region-selection-en', 'value') )
def update_header(key_figure, region_level):
    return f"{key_figure} by {region_level}".capitalize()



@callback(Output('key-figures-finland-whole-country-header-en','children'),
          Input('key-figures-finland-key-figure-selection-en', 'value'))
